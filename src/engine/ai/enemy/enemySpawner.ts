import type { BuildingState, BuildingType, DeploymentUnit, GridState, UnitState, UnitType } from '../../game/types';
import {
  createUnit,
  getCounterUnitType,
...
import { createBuilding, getBuildingBlueprint, getBuildingFootprint } from '../../game/buildingCatalog';
import { isEnemyDeployableCell, isPlayerFlankCell } from '../../game/grid';
import { GAME_CONFIG } from '../../config/gameConfig';
import { addXp, xpRequiredForTier } from '../../game/xp';
import { getRaceBuildingTypes, getRaceUnitTypes } from '../../game/races';
